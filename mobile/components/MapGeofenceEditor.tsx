...
const styles = StyleSheet.create({
  ...
  webTitle: { fontSize: 16, fontWeight: '600', color: '#A1A1AA', textAlign: 'center' },
  webSub: { fontSize: 13, color: '#71717A' },
  nativeContainer: { flex: 1 },
  map: { flex: 1 },
  controls: { backgroundColor: '#18181B', padding: 16, gap: 10, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)' },
  radiusRow: { alignItems: 'center' },
  radiusLabel: { fontSize: 16, fontWeight: '700', color: '#FAFAFA' },
  sliderRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  sliderBound: { fontSize: 11, color: '#71717A' },
  sliderTrack: { flex: 1, height: 6, backgroundColor: '#27272A', borderRadius: 3, overflow: 'hidden' },
